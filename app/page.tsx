      ...
      <main>
        <section className="py-4 md:py-8 relative">
          <div className="container px-8">
            <div className="bg-(--dark-green) rounded-[30px] flex flex-col xl:flex-row overflow-hidden">
              ...
              <div className="min-w-full lg:min-w-174.75 min-h-84 xl:min-h-180 bg-[url('/img/hero.png')] bg-cover bg-center bg-no-repeat relative">
